 ...
 * [selenium-download](https://github.com/groupon/selenium-download) 2.0.10
  ...
  You should not have to install any global dependencies. Selenium server will be downloaded into `node_modules` and nightwatch will be run from `node_modules/.bin`.
